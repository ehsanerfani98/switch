        ...
        <div class="mt-6 md:mt-4">
            ...
            <div class="py-3 my-3 border border-gray-200 rounded-xl bg-[#EBF0F4]">
                ...
                <div class="overflow-hidden transition-all duration-300 max-h-0" id="faq-1">
                    <div class="pb-4">
                        <p class="text-sm font-normal text-gray-900 px-3 md:px-3 mt-3">اختصاص مشاور متخصص به هر درخواست جهت پیگیری، مشاوره تخصصی خرید، کارشناسی فنی رنگ و بدنه، کارشناسی قیمت، مذاکره، تنظیم مبایعه‌نامه و انتقال سند</p>
                    </div>
                </div>
            </div>
                ...
                <div class="overflow-hidden transition-all duration-300 max-h-0" id="faq-2">
                    <div class="pb-4">
                        <div class="flex items-start mr-3">
                            ...
                            <p class="text-sm font-normal text-gray-900 py-2 px-4">تضمین قیمت خودرو</p>
                        </div>
                        <div class="flex items-start mr-3">
                            <div class="flex items-center justify-center mt-2 w-1.5 h-1.5 rounded-full border border-gray-800"></div>
                            <p class="text-sm font-normal text-gray-900 py-2 px-4">کارشناسی و صدور ضمانتنامه کارشناسی</p>
                        </div>
                        <div class="flex items-start mr-3">
                            <div class="flex items-center justify-center mt-2 w-1.5 h-1.5 rounded-full border border-gray-800"></div>
            ...
            <div class="py-3 my-3 border border-gray-200 rounded-xl bg-white">
                <button class="flex justify-between items-center w-full py-2 px-3 text-right">
                    <p class="font-bold text-base md:text-sm text-gray-900 py-2 pl-2">آیا ماشین با ضمانت کارشناسی به من معرفی می شود؟</p>
                    <div class="flex items-center justify-center">
                        <img width="25" alt="" class="transition-transform duration-300 rotate-180" src="/images/icons/arrow-up.svg">
                    </div>
                </button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const firstFaqItem = firstFaq.closest('.py-3.my-3');
        ...
        const faqButtons = document.querySelectorAll('.py-3.my-3 > button');

        faqButtons.forEach(button => {
            button.addEventListener('click', () => {
                const content = button.nextElementSibling;
                const arrow = button.querySelector('img');
                const faqItem = button.closest('.py-3.my-3');
