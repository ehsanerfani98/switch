    ...
    <div class="flex flex-col lg:flex-row overflow-hidden border border-[#EBF0F4] rounded-2xl max-h-[377px]">
        ...
        <div class="w-full lg:w-1/2 p-0">
            <div class="py-6 md:py-3 lg:py-4 px-4 md:px-4 lg:mt-4">
                ...
                <!-- دکمه تماس -->
                <nav class="mt-4">
                    <a href="tel:+989193050846">
                        <button class="flex items-center justify-center mx-auto md:mx-0 bg-[#1D7EB3] rounded-full py-3 px-4 md:px-5 hover:bg-[#166894] transition-colors duration-300">
                            ...
                            <span class="text-white text-sm md:text-base font-medium pr-2">تماس با کارشناس این خودرو</span>
                        </button>
                    </a>
                </nav>
            </div>
