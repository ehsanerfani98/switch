...
@section('content')
                        ...
                        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-6 text-white">
                            <div class="flex flex-col md:flex-row items-center">
                                <div class="md:w-2/3 mb-4 md:mb-0">
                                    <h3 class="text-xl font-bold mb-2">کارشناسان متخصص الوماشین</h3>
                                    <p class="mb-4">با سال‌ها تجربه در زمینه خرید و فروش خودرو، آماده ارائه بهترین
                                        خدمات به شما هستند.</p>
                                    <div class="flex items-center">
                                        <div
                                            class="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center ml-2">
                                            <i class="fas fa-star"></i>
                                        </div>
                                        <div>
                                            <p class="font-bold">۴.۸/۵</p>
                                            <p class="text-sm opacity-80">رضایت مشتریان</p>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="w-full px-4 lg-px-0 py-16 bg-[#F0F4F7]">
        ...
        <div class="text-center mb-8">
            <h1 class="font-bold text-2xl mb-2">مراحل فروش خودرو در الوماشین</h1>
            ...
            <div class="space-y-12">
                ...
                <div class="relative flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div class="w-full lg:w-5/12 lg:pl-8">
                        ...
                        <p class="font-normal text-gray-600 mt-2">بعد از ثبت مشخصات خودرو، مشاوران الوماشین با شما تماس
                            خواهند گرفت.</p>
                    </div>
                </div>
                ...
                <div class="relative flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div class="w-full lg:w-5/12 lg:pr-8 order-2 lg:order-1">
                        ...
                        <p class="font-normal text-gray-600 mt-2">با یکبار مراجعه به دفتر الوماشین کارشناسی رایگان و سپس
                ...
                <div class="relative flex flex-col lg:flex-row items-center justify-between">
                    ...
                    <div class="w-full lg:w-5/12 lg:pr-8 order-2 lg:order-1">
                        ...
                        <p class="font-normal text-gray-600 mt-2">با تایید مشتری توسط شما کارهای اداری مربوط به انتقال
                            سند توسط تیم الوماشین انجام شده و با امضای سند، مراحل فروش خودروی شما به پایان میرسد.</p>
                    </div>
                    <div class="w-full lg:w-5/12 flex justify-center lg:justify-start mb-6 lg:mb-0 lg:pl-8 order-1 lg:order-2">
