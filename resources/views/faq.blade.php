...
@section('content')
    ...
    <section class="faq-hero">
        <div class="container">
            <h1>سوالات متداول</h1>
            <p>پاسخ به پرتکرارترین سوالات کاربران درباره سامانه الوماشین</p>
    ...
    <section class="faq-content">
        <div class="container faq-container">
            ...
            <div class="faq-accordion">
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <span>چگونه در سامانه الوماشین ثبت‌نام کنم؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>برای ثبت‌نام در سامانه الوماشین:</p>
                        <ul>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <span>روش‌های پرداخت در سامانه الوماشین کدامند؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
                        <p>سامانه الوماشین از روش‌های پرداخت زیر پشتیبانی می‌کند:</p>
                        <ul>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        <p>فاکتورها به صورت PDF قابل دانلود هستند و حاوی مهر و امضای الکترونیک سامانه الوماشین می‌باشند.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <div class="faq-question">
                        <span>سازمان ما چگونه می‌تواند در سامانه الوماشین ثبت‌نام کند؟</span>
                        <i class="fas fa-chevron-down"></i>
                    </div>
                    <div class="faq-answer">
            ...
            <div class="faq-contact">
                ...
                <p>می‌توانید از طریق راه‌های ارتباطی زیر با پشتیبانی سامانه الوماشین در تماس باشید. کارشناسان ما آماده
