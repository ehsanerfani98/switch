...
@section('content')
    ...
    <section class="rules-hero">
        <div class="container">
            <h1>قوانین و مقررات سامانه یاد اپ‌تاور</h1>
        ...
        <div class="container rules-container">
            ...
            <div class="rules-section">
                ...
                <ul class="rules-list">
                    ...
                    <li><strong>1.5 پرداخت حق عضویت:</strong> استفاده از خدمات مستلزم پرداخت حق عضویت به شماره حساب معرفی شده از سوی سامانه یاد اپ‌تاور می‌باشد.</li>
                </ul>
            </div>
            ...
            <div class="rules-section">
                ...
                <ul class="rules-list">
                    ...
                    <li><strong>2.2. محدودیت‌های خدمات:</strong> سامانه یاد اپ‌تاور این حق را برای خود محفوظ می‌دارد که در هر زمان، با یا بدون اطلاع قبلی، دسترسی کاربران به خدمات را محدود، تعلیق یا لغو کند، به‌ویژه در صورت نقض قوانین یا تشخیص تخلف.</li>
            ...
            <div class="rules-section">
                ...
                <ul class="rules-list">
                    ...
                    <li><strong>3.4. خسارات غیرمستقیم:</strong> سامانه یاد اپ‌تاور تحت هیچ شرایطی مسئول خسارات غیرمستقیم، از جمله از دست دادن سود، فرصت‌های تجاری، یا داده‌های کاربران، نخواهد بود.</li>
                </ul>
            </div>
            ...
            <div class="rules-section">
                <h2>5. مالکیت فکری</h2>
                <ul class="rules-list">
                    <li><strong>5.1. مالکیت سامانه:</strong> تمامی محتواها، طراحی‌ها، لوگوها، و ابزارهای ارائه‌شده در سامانه یاد اپ‌تاور متعلق به سازمان یا شرکای آن است و استفاده غیرمجاز از آن‌ها ممنوع است.</li>
                    ...
                    <li><strong>5.3. مجوز استفاده:</strong> با بارگذاری محتوا در سامانه، کاربر به یاد اپ‌تاور مجوز غیرانحصاری برای استفاده، نمایش، و ذخیره‌سازی این محتوا در راستای ارائه خدمات اعطا می‌کند.</li>
                </ul>
            </div>
            ...
            <div class="rules-section">
                ...
                <ul class="rules-list">
                    <li><strong>6.1. حق تغییر:</strong> سامانه یاد اپ‌تاور این حق را برای خود محفوظ می‌دارد که در هر زمان، با یا بدون اطلاع قبلی، این قوانین و مقررات را تغییر دهد یا به‌روزرسانی کند.</li>
            ...
            <div class="rules-section">
                ...
                <p>با ثبت‌نام و استفاده از خدمات سامانه یاد اپ‌تاور، شما تأیید می‌کنید که این قوانین و مقررات را به‌طور کامل مطالعه کرده و پذیرفته‌اید. عدم رعایت این قوانین ممکن است منجر به محدودیت دسترسی، تعلیق حساب، یا اقدامات قانونی شود.</p>
            </div>
        </div>
    </section>
@endsection