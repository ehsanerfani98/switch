...
@section('content')
    ...
    <section class="about-hero">
        <div class="container">
            <h1>درباره سامانه الوماشین</h1>
            <p>سامانه الوماشین با هدف ایجاد تحول در ارتباطات سازمانی و ارائه راهکارهای هوشمند برای مدیران و متخصصین کشور تأسیس
                شده است</p>
        </div>
    </section>
    ...
    <section class="about-content">
        <div class="container">
            ...
            <div class="about-section">
                <div class="section-title">
                    <h2>سامانه الوماشین در یک نگاه</h2>
            ...
            <div class="about-section">
                <div class="section-title">
                    <h2>مسیر رشد ما</h2>
                    <p>نگاهی به مهم‌ترین نقاط عطف در مسیر پیشرفت سامانه الوماشین</p>
                </div>
                ...
                <div class="timeline">
                    <div class="timeline-item">
                        <div class="timeline-content">
                            ...
                            <h3>شکل‌گیری ایده</h3>
                            <p>ایده اولیه سامانه الوماشین در جلسات مشترک با سازمان‌های دولتی و شرکت‌های خصوصی شکل گرفت</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-content">
                            ...
                            <h3>تأسیس شرکت</h3>
                            <p>شرکت فناوری اطلاعات الوماشین با هدف توسعه سامانه ارتباطات تخصصی تأسیس شد</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-content">
                            ...
                            <p>سامانه الوماشین به صورت رسمی با حضور وزیر ارتباطات و مدیران ارشد سازمان‌ها راه‌اندازی شد</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-content">
                            ...
                            <h3>گسترش خدمات</h3>
                            <p>با اضافه شدن ماژول‌های جدید، سامانه الوماشین به یک پلتفرم جامع ارتباطات سازمانی تبدیل شد</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="about-section">
                <div class="section-title">
                    <h2>تیم ما</h2>
                    <p>متخصصان و مدیرانی که سامانه الوماشین را به شما معرفی می‌کنند</p>
                </div>
